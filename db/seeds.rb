...
adventure = Genre.create!({name: "Music"})
...
# Adventure
movie1 = Movie.create!({
    title: "Gusttavo Lima - Bloqueado (Buteco In Boston)",
...
Thumbnail.create!({url: "http://localhost:3001/video1.mp4", movie_id: movie1.id})
...
Trailer.create!({url: "http://localhost:3001/video2.mp4", movie_id: movie2.id})
Thumbnail.create!({url: "http://localhost:3001/video2.mp4", movie_id: movie2.id})
...
Trailer.create!({url: "http://localhost:3001/video3.mp4", movie_id: movie3.id})
Thumbnail.create!({url: "http://localhost:3001/video3.mp4", movie_id: movie3.id})
...
Trailer.create!({url: "http://localhost:3001/video4.mp4", movie_id: movie4.id})
Thumbnail.create!({url: "http://localhost:3001/video4.mp4", movie_id: movie4.id})
